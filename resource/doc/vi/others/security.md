...
Để ngăn chặn SQL Injection, hãy cố gắng sử dụng ORM như [illuminate/database](https://www.workerman.net/doc/webman/db/tutorial.html), [think-orm](https://www.workerman.net/doc/webman/db/thinkorm.html) và tránh tự mình lắp ráp câu lệnh SQL.
