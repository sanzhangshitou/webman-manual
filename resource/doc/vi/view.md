...
1. Nếu đường dẫn bắt đầu bằng `/`, sử dụng đường dẫn đó trực tiếp để định vị tệp mẫu.
2. Nếu không bắt đầu bằng `/` và không phải ứng dụng đa ứng dụng, sử dụng tệp mẫu tương ứng trong `app/view/`.
3. Nếu không bắt đầu bằng `/` và là [ứng dụng đa ứng dụng](multiapp.md), sử dụng tệp mẫu tương ứng trong `app/tên_ứng_dụng/view/`.
4. Nếu không truyền tham số mẫu, tệp mẫu sẽ được định vị tự động theo quy tắc 2 và 3.
...
#### Bỏ qua tham số mẫu
Trong các bộ điều khiển dựa trên lớp, bạn có thể bỏ qua tham số mẫu. Ví dụ:
```php
<?php
namespace app\controller;
