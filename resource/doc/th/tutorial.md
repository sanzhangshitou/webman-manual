# ตัวอย่างง่ายสำหรับการเริ่มต้นใช้งาน webman อย่างรวดเร็ว
...
หมายเหตุ：webman ใช้โครงสร้างไวยากรณ์ PHP แบบเดิมเป็นเทมเพลตโดยค่าเริ่มต้น หากต้องการใช้มุมมองอื่นๆ ดูที่ [มุมมอง](view.md)
