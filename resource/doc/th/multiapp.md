...
ใน webman แต่ละไดเรกทอรีภายใต้ app ถือได้ว่าเป็นแอปพลิเคชันหนึ่ง
...
บางครั้งคุณอาจต้องการกำหนด middleware ที่แตกต่างกันสำหรับแอปพลิเคชันต่าง ๆ, เช่น `api` อาจต้องการmiddlware ที่เปิดใช้งาน cross-origin, `admin` อาจต้องการmiddlware ที่ตรวจสอบการเข้าสู่ระบบของผู้ดูแลระบบ, การกำหนด middleware ต่างๆ สำหรับแอปพลิเคชันอาจมีรูปแบบต่อไปนี้ใน `config/middleware.php`:
