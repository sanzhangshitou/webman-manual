...
```
ในโหมดแอปพลิเคชันหลายตัว คุณสามารถกำหนดคลาสการจัดการข้อยกเว้นเป็นแต่ละแอปพลิเคชัน โปรดดูที่ [multiapp.md](multiapp.md)
...
```
## การแสดงผลการตอบกลับ
เมทอด `render` ในคลาสการจัดการข้อยกเว้นถูกใช้ในการแสดงผลการตอบกลับ
...
> **เกร็ดความรู้**
> เนื่องจากข้อยกเว้น BusinessException เป็นข้อยกเว้นทางธุรกิจ (เช่น ข้อผิดพลาดของผู้ใช้ในการป้อนพารามิเตอร์) ซึ่งเป็นประการที่พยากรณ์ได้ เพราะฉะนั้นเฟรมเวิร์คจึงไม่พิจารณาว่าเป็นข้อผิดพลาดร้ายแรง และจะไม่บันทึกลงในบันทึก
