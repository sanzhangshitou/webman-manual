...
และ twig、blade、think-template ฯลฯ จะทำการแปลง XSS โดยอัตโนมัติ ไม่ต้องแปลงด้วยตนเอง สะดวกมาก
...
เพื่อป้องกันการฉีดโค้ด SQL โปรดใช้ ORM มากที่สุดเท่าที่ทำได้ เช่น [illuminate/database](https://www.workerman.net/doc/webman/db/tutorial.html)、[think-orm](https://www.workerman.net/doc/webman/db/thinkorm.html) และเมื่อใช้แล้วพยายามอย่ารวบรวมคำสั่ง SQL เอง

## พร็อกซี่ nginx
เมื่อแอปพลิเคชันของคุณจำเป็นต้องเปิดเผยแก่ผู้ใช้อินเทอร์เน็ต ขอแนะนำอย่างยิ่งให้เพิ่มพร็อกซี่ nginx หน้า webman เพื่อกรองคำขอ HTTP ที่ผิดกฎหมายบางส่วน และเพิ่มความปลอดภัย รายละเอียดเพิ่มเติมโปรดดูที่ [พร็อกซี่ nginx](nginx-proxy.md)
