# एकाधिक अनुप्रयोग
कभी-कभी एक परियोजना को कई उप-परियोजनाओं में विभाजित किया जा सकता है, उदाहरण के लिए एक मॉल को मॉल मुख्य परियोजना, मॉल API इंटरफेस और मॉल प्रबंधन बैकएंड तीन उप-परियोजनाओं में बाँटा जा सकता है, जो सभी एक ही डेटाबेस कॉन्फ़िगरेशन का उपयोग करते हैं।
...
webman में, app के तहत प्रत्येक निर्देशिका को एक अनुप्रयोग के रूप में माना जा सकता है।
...
कभी-कभी आपको अलग-अलग एप्लिकेशन के लिए अलग-अलग मिडलवेयर कॉन्फ़िगर करना चाहिए, जैसे कि `api` एप्लिकेशन में कोर्स मिडलवेयर की आवश्यकता हो सकती है, `admin` में व्यवस्थापक लॉगिन की जांच करने वाली मिडलवेयर की आवश्यकता हो सकती है, इसलिए `config/middleware.php` को निम्नलिखित तरह कॉन्फ़िगर किया जा सकता है:
```php
return [
    // ग्लोबल मिडलवेयर
    '' => [
