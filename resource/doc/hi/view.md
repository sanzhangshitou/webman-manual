...
1. यदि पथ `/` से शुरू होता है, तो दृश्य फ़ाइल को खोजने के लिए उस पथ का सीधे उपयोग करें।
2. यदि `/` से शुरू नहीं होता है और बहु-एप्लिकेशन नहीं है, तो `app/view/` के नीचे संबंधित दृश्य फ़ाइल का उपयोग करें।
3. यदि `/` से शुरू नहीं होता है और [बहु-एप्लिकेशन](multiapp.md) है, तो `app/एप्लिकेशननाम/view/` के नीचे संबंधित दृश्य फ़ाइल का उपयोग करें।
4. यदि टेम्प्लेट पैरामीटर नहीं पास किया गया है, तो नियम 2 और 3 के अनुसार टेम्प्लेट फ़ाइल स्वचालित रूप से खोजी जाएगी।
...
class UserController
{
    public function hello(Request $request)
    {
        // return view('user/hello', ['name' => 'webman']); के बराबर
        // return view('/app/view/user/hello', ['name' => 'webman']); के बराबर
...
#### टेम्प्लेट पैरामीटर छोड़ना
क्लास-आधारित नियंत्रकों में आप टेम्प्लेट पैरामीटर छोड़ सकते हैं। उदाहरण:
```php
<?php
namespace app\controller;
