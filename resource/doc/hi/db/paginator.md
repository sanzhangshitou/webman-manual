...
# Laravel ORM पर आधारित पेजिनेशन
...
# ThinkPHP ORM पर आधारित पेजिनेशन

अतिरिक्त लाइब्रेरी स्थापित करने की आवश्यकता नहीं है; केवल think-orm स्थापित होना पर्याप्त है।
## उपयोग
```php
public function index(Request $request)
{
