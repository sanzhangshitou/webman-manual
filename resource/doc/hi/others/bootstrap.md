...
## अतिरिक्त स्पष्टीकरण
[कस्टम प्रक्रिया](../process.md) प्रारंभ होने के बाद भी `config/bootstrap.php` में सेट किए गए start मेथड को चलाया जाएगा। हम `$worker->name` का उपयोग करके वर्तमान प्रक्रिया कौन सी है यह निर्धारित कर सकते हैं, और आगे `$worker->id` से प्रक्रिया संख्या जान सकते हैं, फिर तय कर सकते हैं कि उस प्रक्रिया में अपना व्यावसायिक प्रारंभ कोड चलाना है या नहीं। उदाहरण के लिए, यदि हमें केवल webman की प्रक्रिया 0 में चलाना है, तो `MemReport.php` की सामग्री निम्नलिखित तरह होगी:
```php
<?php
