...
> **सुझाव**
> क्रॉस-ओरिजिन अनुरोध OPTIONS प्रीफ्लाइट अनुरोध उत्पन्न कर सकते हैं। हम नहीं चाहते कि OPTIONS अनुरोध नियंत्रक तक पहुंचे, इसलिए हम अनुरोध को रोकने के लिए सीधे खाली प्रतिक्रिया (`response('')`) लौटाते हैं।
> यदि आपके API को रूटिंग की आवश्यकता है, `Route::any(..)` या `Route::add(['POST', 'OPTIONS'], ..)` का उपयोग करें।
...
एनोटेशन का उपयोग करके, हम किसी नियंत्रक या नियंत्रक की विशिष्ट विधियों को मिडलवेयर असाइन कर सकते हैं।
...
कॉन्फ़िग फ़ाइल सीधे मिडलवेयर इंस्टैंसिएशन का समर्थन करती है, जिससे कंस्ट्रक्टर के माध्यम से मिडलवेयर को पैरामीटर पास करना आसान हो जाता है।
...
समान रूप से, रूट मिडलवेयर भी कंस्ट्रक्टर के माध्यम से पैरामीटर पास कर सकता है, उदाहरण के लिए `config/route.php` में:
...
मिडलवेयर में पैरामीटर उपयोग उदाहरण:
...
```
## मिडलवेयर क्रम
- मिडलवेयर क्रम: `ग्लोबल मिडलवेयर` -> `एप्लीकेशन मिडलवेयर` -> `नियंत्रक मिडलवेयर` -> `रूट मिडलवेयर` -> `विधि मिडलवेयर`।
- जब एक ही स्तर पर कई मिडलवेयर हैं, तो वे कॉन्फ़िगरेशन क्रम में निष्पादित होते हैं।
- 404 अनुरोध डिफ़ॉल्ट रूप से कोई मिडलवेयर ट्रिगर नहीं करता (फिर भी `Route::fallback(function(){})->middleware()` के माध्यम से मिडलवेयर जोड़ा जा सकता है)।
...
return [
    ...
    'plugin.ai.admin' => [], // ai प्लगइन के व्यवस्थापक मॉड्यूल में मिडलवेयर जोड़ें (plugin\ai\app\admin निर्देशिका)
];
```
