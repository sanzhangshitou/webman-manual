...
這樣慢介面可以走 `http://127.0.0.1:8686/` 這組進程，不影響其它進程的業務處理。
...
> **提示**
> 本例中使用了 `workerman/http-client` 客戶端非同步取得 HTTP 結果並返回資料，也可以使用其它非同步客戶端例如 [AsyncTcpConnection](https://www.workerman.net/doc/workerman/async-tcp-connection/construct.html)。
