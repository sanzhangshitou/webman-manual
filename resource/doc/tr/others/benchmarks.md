...
Ayrıca, keep-alive açılmadan yapılan performans testlerinde, istemci tarafındaki yerel portlar TIME_WAIT durumundaki bağlantılar nedeniyle hızla tükenir. Bu, toplam istek sayısı belirli bir eşiği (genellikle yaklaşık 28.000) aştığında başarısız istekler şeklinde kendini gösterir.
...
**Ortam**
Alibaba Cloud 4 çekirdek 4 GB, yerel MySQL veritabanı, 100.000 kayıttan rastgele bir kayıt sorgulayıp JSON olarak döndürme, yerel performans testi.
...
> **Not**
> ORM kullanmanın bir miktar performans kaybına neden olmasına rağmen, iş senaryolarının %99'u için performans zaten fazlasıyla yeterlidir. Kalan %1'e denk gelirseniz, daha fazla CPU veya sunucu ekleyerek kolayca çözebilirsiniz.
> Geliştirme verimliliği, sürdürülebilirlik, performans gibi birden çok kriter arasında denge bulmalıyız, performansı körü körüne takip etmemeliyiz.
