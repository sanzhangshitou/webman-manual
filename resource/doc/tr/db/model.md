...
Not: Eloquent ORM'ın model gözlemcilerini desteklemesi için `composer require "illuminate/events"` paketinin ayrıca yüklenmesi gerekir.
...
## İşlemler
[Veritabanı işlemleri](../others/transaction.md) bölümüne bakın
