...
এছাড়াও, যদি কীপ-অ্যালাইভ চালু না করে প্রেসার টেস্ট করা হয়, তাহলে ক্লায়েন্টের লোকাল পোর্টগুলো TIME_WAIT অবস্থার সংযোগের কারণে দ্রুত শেষ হয়ে যাবে। মোট রিকোয়েস্ট সংখ্যা একটি নির্দিষ্ট সীমা (সাধারণত প্রায় ২৮,০০০) অতিক্রম করলে ব্যর্থ রিকোয়েস্ট দেখা দেবে।

## প্রেসার টেস্টের সময় HTTP keep-alive কিভাবে চালু করবেন?
...
**পরিবেশ**
আলিবাবা ক্লাউড ৪ কোর ৪জি সার্ভার, লোকাল MySQL ডাটাবেস, ১ লক্ষ রেকর্ড থেকে রেন্ডমলি একটি রেকর্ড কুয়েরি করে JSON রিটার্ন, লোকাল প্রেসার টেস্ট।
...
> **পরামর্শ**
> ORM ব্যবহার করলে কার্যকারিতা কিছু কমে যায়, তবে ৯৯% ব্যবসায়িক সিনারিওর জন্য কার্যকারিতা ইতিমধ্যে পর্যাপ্তের চেয়ে বেশি। আপনি যদি বাকি ১%-এর মধ্যে থাকেন, তাহলে আরও CPU বা সার্ভার যোগ করে সহজেই সমাধান করতে পারবেন।
> আমরা ডেভেলপমেন্ট দক্ষতা, রক্ষণাবেক্ষণযোগ্যতা, কার্যকারিতা ইত্যাদি একাধিক সূচকে ভারসাম্য খুঁজে বের করতে হবে, শুধু কার্যকারিতার পিছনে অন্ধভাবে দৌড়ানো উচিত নয়।
