...
## ভিউ ফাইল পাথ
#### কন্ট্রোলার
কন্ট্রোলার যখন `view('মডেলনাম',[]);` দিলে, ভিউ ফাইল নিম্নলিখিত নিয়ম অনুসরণ করে অনুসন্ধান করা হয়:

1. পথ যদি `/` দিয়ে শুরু হয় তবে সেই পথটি সরাসরি ভিউ ফাইল খুঁজতে ব্যবহার করুন।
2. `/` দিয়ে শুরু না হলে এবং বহু-অ্যাপ্লিকেশন না হলে, `app/view/` এর অধীনে সংশ্লিষ্ট ভিউ ফাইল ব্যবহার করুন।
3. `/` দিয়ে শুরু না হলে এবং [বহু-অ্যাপ্লিকেশন](multiapp.md) হলে, `app/অ্যাপ্লিকেশননাম/view/` এর অধীনে সংশ্লিষ্ট ভিউ ফাইল ব্যবহার করুন।
4. টেমপ্লেট প্যারামিটার না পাঠালে, নিয়ম ২ ও ৩ অনুযায়ী টেমপ্লেট ফাইল স্বয়ংক্রিয়ভাবে অনুসন্ধান করা হয়।
...
class UserController
{
    public function hello(Request $request)
    {
        // return view('user/hello', ['name' => 'webman']); এর সমতুল্য
        // return view('/app/view/user/hello', ['name' => 'webman']); এর সমতুল্য
...
#### টেমপ্লেট প্যারামিটার বাদ দেওয়া
ক্লাস-ভিত্তিক কন্ট্রোলারে আপনি টেমপ্লেট প্যারামিটার বাদ দিতে পারেন। উদাহরণ:
```php
<?php
namespace app\controller;
