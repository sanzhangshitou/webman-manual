...
> **পরামর্শ**
> ক্রস-অরিজিন অনুরোধ OPTIONS প্রিফ্লাইট অনুরোধ ট্রিগার করতে পারে। আমরা OPTIONS অনুরোধ কন্ট্রোলারে পৌঁছাতে চাই না, তাই আমরা অনুরোধ বাধা দিতে সরাসরি একটি খালি প্রতিক্রিয়া ফেরত দিই (`response('')`)।
> যদি আপনার API-এর রাউটিং সেটআপের প্রয়োজন হয়, `Route::any(..)` বা `Route::add(['POST', 'OPTIONS'], ..)` ব্যবহার করুন।
...
## ব্যাখ্যা, কন্ট্রোলার মিডলওয়্যার ও মেথড মিডলওয়্যার, রুট মিডলওয়্যার

মিডলওয়্যারকে গ্লোবাল মিডলওয়্যার, অ্যাপ্লিকেশন মিডলওয়্যার ([মাল্টিঅ্যাপ](multiapp.md) দেখুন) এবং রুট মিডলওয়্যারে বিভক্ত করা হয়েছে। এনোটেশন ব্যবহার করে আমরা একটি কন্ট্রোলার বা নির্দিষ্ট মেথডে মিডলওয়্যার অ্যাসাইন করতে পারি।
...
`config/route.php`-এ রুট মিডলওয়্যার কনফিগার করুন। কনস্ট্রাক্টরের মাধ্যমে প্যারামিটার পাস করতে `new` দিয়ে সরাসরি ইন্সট্যান্টiate করুন। মিডলওয়্যার কার্যনির্বাহের ক্রম: `গ্লোবাল` -> `অ্যাপ্লিকেশন` -> `কন্ট্রোলার` -> `রুট` -> `মেথড`। ৪০৪ অনুরোধ ডিফল্টভাবে কোনো মিডলওয়্যার ট্রিগার করে না (`Route::fallback(function(){})->middleware()` দিয়ে যোগ করা যেতে পারে)।
...
return [
    ...
    'plugin.ai.admin' => [], // ai প্লাগইনের অ্যাডমিন মডিউলে মিডলওয়্যার যোগ করুন (plugin\ai\app\admin ডিরেক্টরি)
];
```
